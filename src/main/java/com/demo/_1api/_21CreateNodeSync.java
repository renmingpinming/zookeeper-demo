...
public class _21CreateNodeSync implements Watcher {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		zookeeper = new ZooKeeper("localhost:2181", 5000, new _21CreateNodeSync());
...
//		zookeeper.close();
	...
	private void doSomething() {
		try {
			...
			String path = zookeeper.create("/node21", "123".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
